...
void
user_input_destroy(struct user_input* input)
{
...
int
user_input_get_fd(struct user_input* input)
{
    DEBUG_ASSERT(input != NULL);
...
static void
flush_pointer_events(struct user_input* input)
{
    DEBUG_ASSERT(input != NULL);
...
static void
emit_pointer_events(struct user_input* input, const FlutterPointerEvent* events, size_t n_events)
{
    DEBUG_ASSERT(input != NULL);
 ...
 */
static void
maybe_enable_mouse_cursor(struct user_input* input, uint64_t timestamp)
{
    DEBUG_ASSERT(input != NULL);
 ...
 */
static void
maybe_disable_mouse_cursor(struct user_input* input, uint64_t timestamp)
{
    DEBUG_ASSERT(input != NULL);
...
static int
on_device_added(struct user_input* input, struct libinput_event* event, uint64_t timestamp)
{
...
static int
on_device_removed(struct user_input* input, struct libinput_event* event, uint64_t timestamp)
{
    struct input_device_data* data;
    struct libinput_device* device;
...
static int
on_key_event(struct user_input* input, struct libinput_event* event)
{
    ...
    input->interface.on_gtk_keyevent(
      ...
      keyboard_state_is_shift_active(data->keyboard_state) | (keyboard_state_is_capslock_active(data->keyboard_state) << 1) | (keyboard_state_is_ctrl_active(data->keyboard_state) << 2) | (keyboard_state_is_alt_active(data->keyboard_state) << 3) | (keyboard_state_is_numlock_active(data->keyboard_state) << 4) | (keyboard_state_is_meta_active(data->keyboard_state) << 28),
      key_state);
...
static int
on_mouse_motion_event(struct user_input* input, struct libinput_event* event)
{
...
static int
on_mouse_motion_absolute_event(struct user_input* input, struct libinput_event* event)
{
    struct libinput_event_pointer* pointer_event;
    struct input_device_data* data;
    struct libinput_device* device;
...
static int
on_mouse_button_event(struct user_input* input, struct libinput_event* event)
{
    struct libinput_event_pointer* pointer_event;
...
static int
on_mouse_axis_event(struct user_input* input, struct libinput_event* event)
{
    struct libinput_event_pointer* pointer_event;
    struct input_device_data* data;
    struct libinput_device* device;
...
static int
on_touch_down(struct user_input* input, struct libinput_event* event)
{
...
static int
on_touch_up(struct user_input* input, struct libinput_event* event)
{
    struct libinput_event_touch* touch_event;
    struct input_device_data* data;
    uint64_t timestamp;
...
static int
on_touch_motion(struct user_input* input, struct libinput_event* event)
{
    struct libinput_event_touch* touch_event;
    struct input_device_data* data;
    uint64_t timestamp;
...
static int
on_touch_cancel(struct user_input* input, struct libinput_event* event)
{
    DEBUG_ASSERT(input != NULL);
    DEBUG_ASSERT(event != NULL);
...
static int
on_touch_frame(struct user_input* input, struct libinput_event* event)
{
    DEBUG_ASSERT(input != NULL);
    DEBUG_ASSERT(event != NULL);
...
static int
process_libinput_events(struct user_input* input, uint64_t timestamp)
{
...
int
user_input_on_fd_ready(struct user_input* input)
{
